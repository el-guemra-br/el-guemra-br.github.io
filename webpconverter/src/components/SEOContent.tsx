  ...
  <img src="image.jpg" alt="Description" />
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl bg-violet-50 border border-violet-100 p-6 text-center">
              <div className="text-3xl mb-3" style={{ alignItems: "center" }}><img src={`${import.meta.env.BASE_URL}icons/rocket-chat.webp`} alt="Ready to optimize?" className="w-8 h-8" /></div>
